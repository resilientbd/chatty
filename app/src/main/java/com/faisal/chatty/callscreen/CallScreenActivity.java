package com.faisal.chatty.callscreen;

/**
 * Create by Sk. Faisal
 * purpose: display caller screen
...
import com.faisal.util.local.Constrants;
...
public class CallScreenActivity extends BaseActivity {
    ...
    private void updateUI() {
        ...
        if (call != null) {
            ...
            mCallerName.setText(getIntent().getStringExtra(Constrants.Intents.USER_NAME));
